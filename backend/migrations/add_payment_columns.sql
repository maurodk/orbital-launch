...
ALTER TABLE public.pagamentos
  ADD COLUMN IF NOT EXISTS valor_unidade numeric;
...
COMMENT ON COLUMN public.pagamentos.valor IS 'Valor total da unidade em R$';
COMMENT ON COLUMN public.pagamentos.tipo_pagamento IS 'Tipo de pagamento presencial (pix, dinheiro, cartao, cheque)';
