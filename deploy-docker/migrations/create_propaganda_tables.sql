create table if not exists public.propaganda_campaigns (
  ...
  media_path text,
  media_muted boolean not null default false,
  media_volume numeric(4,3) not null default 1 check (media_volume >= 0 and media_volume <= 1),
  ...
  transition_media_muted boolean not null default false,
  transition_media_volume numeric(4,3) not null default 1 check (transition_media_volume >= 0 and transition_media_volume <= 1),
  ...
  transition_entry_muted boolean not null default false,
  transition_entry_volume numeric(4,3) not null default 1 check (transition_entry_volume >= 0 and transition_entry_volume <= 1),
  ...
  transition_exit_muted boolean not null default false,
  transition_exit_volume numeric(4,3) not null default 1 check (transition_exit_volume >= 0 and transition_exit_volume <= 1),
...
create table if not exists public.propaganda_runtime (
  ...
  active_media_muted boolean not null default false,
  active_media_volume numeric(4,3) not null default 1 check (active_media_volume >= 0 and active_media_volume <= 1),
  ...
  active_transition_media_muted boolean not null default false,
  active_transition_media_volume numeric(4,3) not null default 1 check (active_transition_media_volume >= 0 and active_transition_media_volume <= 1),
  ...
  active_transition_entry_muted boolean not null default false,
  active_transition_entry_volume numeric(4,3) not null default 1 check (active_transition_entry_volume >= 0 and active_transition_entry_volume <= 1),
  ...
  active_transition_exit_muted boolean not null default false,
  active_transition_exit_volume numeric(4,3) not null default 1 check (active_transition_exit_volume >= 0 and active_transition_exit_volume <= 1),
